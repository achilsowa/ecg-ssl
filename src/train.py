...
from icmhi.ecgssl.src.utils.helper import (
    load_checkpoint,
    init_model,
    init_opt,
    init_local_config)
...
def main(args, resume_preempt=False):
    ...
    data_kwargs = {"x_label": x_label, "clean": clean, }
    train_args_data = init_local_config(args['data']['train'], **data_kwargs)
    is_1d = x_label == "ecg"
    ...
    transform = make_transforms(
        ...
        normalization=train_args_data.get('normalization', None))
