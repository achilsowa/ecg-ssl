...
def nt_xent_loss(Z, temp=1.0, rank=0):
    ...
    logits_aa = logits_aa - masks * LARGE_NUM # in the paper we do not take into account s(i,i) ([k!=i], algorithm 1 pseudo code)
    logits_bb = torch.mm(Z_n1_2n, Z_n1_2n_large.t()) / temp
    logits_bb = logits_bb - masks * LARGE_NUM # same as top
